...
const StreakCard: React.FC<StreakCardProps> = ({
  ...
  return (
    <motion.div
      className={`rounded-3xl bg-white/5 backdrop-blur-md p-5 ${className}`}
    ...
    >
      <div className="flex gap-4">
        ...
        <div className="relative flex-shrink-0">
          <div className="w-20 h-20 rounded-2xl bg-black/20 flex items-center justify-center">
