...
const ALIGN_CLASSNAMES: Record<InputGroupAddonAlign, string> = {
  "inline-start":
    "order-0 inline-flex items-center gap-[--input-group-addon-gap] px-3 py-2",
  "inline-end":
    "order-1 ml-auto inline-flex items-center gap-[--input-group-addon-gap] px-3 py-2",
  "block-start":
    "order-0 flex w-full items-center gap-[--input-group-addon-gap] px-3 py-2",
  "block-end":
    "order-2 flex w-full items-center gap-[--input-group-addon-gap] px-3 py-2",
};
